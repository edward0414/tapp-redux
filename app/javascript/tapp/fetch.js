...
export const is_valid_instructor = (utorid, appState) => {
  return fetch("/instructors/utorid/" + utorid)
    .then(response => {
...
const getApplicants = (utorid = null) =>
  !utorid
    ? getResource(
        "/applicants",
    ...
    : getResource(
        "/instructors/" + utorid + "/applicants",
        fetchProc.onFetchApplicantsSuccess,
        "applicants",
        appState.setApplicantsList
      );

const getApplications = (utorid = null) =>
  !utorid
    ? getResource(
        "/applications",
    ...
    : getResource(
        "/instructors/" + utorid + "/applications",
        fetchProc.onFetchApplicationsSuccess,
        "applications",
        appState.setApplicationsList
      );

const getCourses = (utorid = null) =>
  !utorid
    ? getResource(
        "/positions",
    ...
    : getResource(
        "/instructors/" + utorid + "/positions",
        fetchProc.onFetchTappCoursesSuccess,
        "courses",
        appState.setCoursesList
      );

const getAssignments = (utorid = null) =>
  !utorid
    ? getResource(
        "/assignments",
    ...
    : getResource(
        "/instructors/" + utorid + "/assignments",
        fetchProc.onFetchAssignmentsSuccess,
        "assignments",
        appState.setAssignmentsList
      );
