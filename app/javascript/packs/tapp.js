...
import { Courses } from "../tapp/scenes/courses/courses";
import { ABC } from "../tapp/scenes/abc/abc";
import { Assigned } from "../tapp/scenes/assigned/assigned";
import { Unassigned } from "../tapp/scenes/unassigned/unassigned";
import { Summary } from "../tapp/scenes/summary/summary";
import { Assistant } from "../tapp/scenes/assistant/assistant";
      ...
      <div>
        ...
        <Switch>
          <Route
            ...
            render={() =>
              <Courses navKey={routeConfig.courses.id} {...props} />}
          />
          <Route
          ...
          <Route
            ...
            render={() =>
              <Assigned navKey={routeConfig.assigned.id} {...props} />}
          />
          <Route
            path={routeConfig.unassigned.route}
            render={() =>
              <Unassigned navKey={routeConfig.unassigned.id} {...props} />}
          />
          <Route
            path={routeConfig.summary.route}
            render={() =>
              <Summary navKey={routeConfig.summary.id} {...props} />}
          />
      ...
      <div>
        ...
        <Switch>
          <Route
            ...
            render={() =>
              <Assistant navKey={routeConfig.assistant.id} {...props} />}
          />
